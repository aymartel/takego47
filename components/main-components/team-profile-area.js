...
import teamProfile from "@/images/team/team-profile.jpg";
import logo1 from "@/images/team/logo1.png";
import logo2 from "@/images/team/logo2.png";
import logo3 from "@/images/team/logo3.png";
      ...
      <div className="container">
        <div className="row large-gap justify-content-between">
          <div className="col-lg-5">
            <div className="team-profile-image rmb-65 wow fadeInRight delay-0-1s">
              <Image  
                src={teamProfile}
                alt="Team Member"
              />
          ...
          <div className="col-lg-7">
            <div className="team-profile-content wow fadeInLeft delay-0-1s">
              ...
              <hr />
              <div className="circle-counter wow fadeInUp delay-0-1s">
              ...
              <div className="experience-wrap pt-20">
                <div className="experience-item wow fadeInUp delay-0-1s">
                  <div className="image">
